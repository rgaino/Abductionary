...
NSString * const kCommonFontName = @"geogtq-bd-webfont";
NSString * const kGameOverScoreFontName = @"InterstateBlack.ttf";
...
NSString * const kThreePointLetters = @"bcmp";
NSString * const kFourPointLetters = @"fhvwy";
NSString * const kFivePointLetters = @"k";
NSString * const kEightPointLetters = @"jx";
NSString * const kTenPointLetters = @"qz";
