...
-(void) setupButtons 
{
    ...
    CCLabelTTF *mainMenuLabel = [CCLabelTTF labelWithString:@"MAIN MENU" fontName:kCommonFontName fontSize:20];
...
{    
    ...
    id panGameOver = [CCMoveTo actionWithDuration:kPanGameOverAnimationDuration position:ccp(0, (screenSize.height*5)-256)];
